...
std::vector<char> Rule30::makeVectorWrittable()
{
...
// Private functions
bool Rule30::apply(const std::array<bool, 3> &parents)
{
...
std::map<int, std::vector<int>> Rule30::primeNumberAnalisis(
...
// Getters
std::vector<bool> Rule30::getSpace(int generation)
{
...
void Rule30::displayFile(int generation)
{
